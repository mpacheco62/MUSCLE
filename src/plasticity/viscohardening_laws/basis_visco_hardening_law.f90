module mod_visco_hardening_law
    ...
    !! ========================
    !!
    !! Defines the abstract base type for hardening laws used in visco-plasticity models.
    !!
    !! This module provides an abstract derived type, `Base_visco_hardening_law`, which serves as
    ...
    !!
    !! - `Base_visco_hardening_law`: Abstract base type for isotropic hardening laws.
    ...
    !! ------------------
    !!
    !! Concrete hardening laws will extend `Base_visco_hardening_law`:
    !!
    !! ```fortran
    ...
    !!   implicit none
    !!
    !!   type, extends(Base_visco_hardening_law) :: LinearHardening
    ...
    !!
    !! program use_visco_hardening_law
    !!   use mod_linear_hardening
    !!   use iso_fortran_env, only: real64
    !!   implicit none
    !!
    !!   type(LinearHardening) :: material_hardening
    !!   class(Base_visco_hardening_law), allocatable :: law_ptr
    ...
    !!   deallocate(law_ptr)
    !!
    !! end program use_visco_hardening_law
    !! ```
    ...
    type, abstract :: Base_visco_hardening_law
        ...
        !! in visco-plasticity models. The independent variable is typically the equivalent plastic strain and its change rate.
        contains
    ...
    interface
        pure function stress_interface(self, ep) result(res)
            ...
            !! Must be implemented by concrete subtypes of `Base_visco_hardening_law`.
            use, intrinsic :: iso_fortran_env
