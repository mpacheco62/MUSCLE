module mod_operator_I4O3T_3D4O3sym
    ...
    ! pure module function ddot_I4O3T_3D4O3sym(I2, b) result(res)
    !     implicit none
    ...
    ! pure module function ddot_3D4O3sym_I4O3T(b, I2) result(res)
    !     implicit none
    !     class(iden_4O3T), intent(in) :: I2
    !     class(ten_3D4O3sym), intent(in) :: b
    !     real(real64) :: res
    ...
    pure module function sum_I4O3T_3D4O3sym(I2, a) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I2
    ...
    pure module function sum_3D4O3sym_I4O3T(a, I2) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
    ...
    pure module function sub_I4O3T_3D4O3sym(I2, a) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
    ...
    pure module function sub_3D4O3sym_I4O3T(a, I2) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
