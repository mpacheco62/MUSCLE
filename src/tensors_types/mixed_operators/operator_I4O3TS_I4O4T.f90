module mod_operator_I4O3TS_I4O4T
    ...
    pure function sum_I4O3TS_I4O4T(I3, I4) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I3
        class(iden_4O4T), intent(in) :: I4
        type(ten_3D4O3sym) :: res
        res%vals = (/1D0+I3%val, 1D0+I3%val, 1D0+I3%val, 0.5D0, 0.5D0, 0.5D0, &
    ...
    pure function sum_I4O4T_I4O3TS(I4, I3) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I3
        class(iden_4O4T), intent(in) :: I4
        type(ten_3D4O3sym) :: res
    ...
    pure function sub_I4O3TS_I4O4T(I3, I4) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I3
        class(iden_4O4T), intent(in) :: I4
        type(ten_3D4O3sym) :: res
        res%vals = (/I3%val-1D0, I3%val-1D0, I3%val-1D0, -0.5D0, -0.5D0, -0.5D0, &
                     I3%val, I3%val, 0D0, 0D0, 0D0, I3%val, &
                     0D0, 0D0, 0D0, 0D0, 0D0, 0D0, &
                     0D0, 0D0, 0D0/)
        !              1    2    3      4      5      6    
    ...
    pure function sub_I4O4T_I4O3TS(I4, I3) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I3
        class(iden_4O4T), intent(in) :: I4
        type(ten_3D4O3sym) :: res
