module mod_operator_I3D4O4T_3D4O3sym
    ...
    public :: operator(+)
    interface operator (+)
        module procedure sum_3D4O3sym_I3D4O4T
        module procedure sum_I3D4O4T_3D4O3sym
    end interface

    public :: operator(-)
    interface operator (-)
        module procedure sub_3D4O3sym_I3D4O4T
        module procedure sub_I3D4O4T_3D4O3sym
    end interface
    
    ! public :: operator(.ddot.)
    ! interface operator (.ddot.)
    !     module procedure ddot_I3D4O4T_3D4O3sym
    !     module procedure ddot_3D4O3sym_I3D4O4T
    ! end interface
    ...
    ! end function ddot_I3D4O4T_3D4O3sym
    ...
    !     real(real64) :: res
    !     res = b%vals(1) + b%vals(2) + b%vals(3)
    ! end function ddot_3D4O3sym_I3D4O4T
...
end module mod_operator_I3D4O4T_3D4O3sym