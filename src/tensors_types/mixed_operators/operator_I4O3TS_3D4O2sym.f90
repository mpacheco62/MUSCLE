module mod_operator_I4O3TS_3D4O2sym
    ...
    pure function sum_I4O3TS_3D4O2sym(I2, a) result(res)
        implicit none
    ...
    pure function sum_3D4O2sym_I4O3TS(a, I2) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I2
        type(ten_3D4O2sym), intent(in) :: a
        type(ten_3D4O2sym) :: res
    ...
    pure function sub_I4O3TS_3D4O2sym(I2, a) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I2
        type(ten_3D4O2sym), intent(in) :: a
        type(ten_3D4O2sym) :: res
    ...
    pure function sub_3D4O2sym_I4O3TS(a, I2) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: I2
        type(ten_3D4O2sym), intent(in) :: a
        type(ten_3D4O2sym) :: res
