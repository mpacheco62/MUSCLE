module mod_operator_I4O3T_I4O4TS
    ...
    pure function sum_I4O3T_I4O4TS(I3, I4) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I3
        class(iden_4O4TS), intent(in) :: I4
        type(ten_3D4O3sym) :: res
        res%vals = (/I4%val+1D0, I4%val+1D0, I4%val+1D0, 0.5D0*I4%val, 0.5D0*I4%val, 0.5D0*I4%val, &
    ...
    pure function sum_I4O4TS_I4O3T(I4, I3) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I3
        class(iden_4O4TS), intent(in) :: I4
        type(ten_3D4O3sym) :: res
    ...
    pure function sub_I4O3T_I4O4TS(I3, I4) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I3
        class(iden_4O4TS), intent(in) :: I4
        type(ten_3D4O3sym) :: res
        res%vals = (/1D0-I4%val, 1D0-I4%val, 1D0-I4%val, -0.5D0*I4%val, -0.5D0*I4%val, -0.5D0*I4%val, &
                     1D0, 1D0, 0D0, 0D0, 0D0, 1D0, &
                     0D0, 0D0, 0D0, 0D0, 0D0, 0D0, &
                     0D0, 0D0, 0D0/)
        !              1    2    3      4      5      6    
    ...
    pure function sub_I4O4TS_I4O3T(I4, I3) result(res)
        implicit none
        class(iden_4O3T), intent(in) :: I3
        class(iden_4O4TS), intent(in) :: I4
        type(ten_3D4O3sym) :: res
