module mod_operator_I3D2O_3D2Osym
    ...
    public :: operator(+)
    interface operator (+)
        module procedure sum_3D2Osym_I3D2O
        module procedure sum_I3D2O_3D2Osym
    end interface

    public :: operator(-)
    interface operator (-)
        module procedure sub_3D2Osym_I3D2O
        module procedure sub_I3D2O_3D2Osym
    end interface
    
    public :: operator(*)
    interface operator (*)
        module procedure mul_3D2Osym_I3D2O
        module procedure mul_I3D2O_3D2Osym
    end interface

    public :: operator(.ddot.)
    interface operator (.ddot.)
        module procedure ddot_I3D2O_3D2Osym
        module procedure ddot_3D2Osym_I3D2O
    end interface
    ...
    end function ddot_I3D2O_3D2Osym
    ...
    pure module function ddot_3D2Osym_I3D2O(b, I2) result(res)
        ...
        real(real64) :: res
        res = b%vals(1) + b%vals(2) + b%vals(3)
    end function ddot_3D2Osym_I3D2O
    ...
    end function sum_I3D2O_3D2Osym
    ...
    pure module function sum_3D2Osym_I3D2O(a, I2) result(res)
        ...
        res%vals = a%vals
        res%vals(1:3) = res%vals(1:3) + 1D0
    end function sum_3D2Osym_I3D2O
    ...
    end function sub_I3D2O_3D2Osym
    ...
    pure module function sub_3D2Osym_I3D2O(a, I2) result(res)
        ...
        res%vals = a%vals
        res%vals(1:3) = res%vals(1:3) - 1D0
    end function sub_3D2Osym_I3D2O
    ...
    pure module function mul_I3D2O_3D2Osym(I2, a) result(res)
        ...
        type(ten_3D2Osym) :: res
        res%vals = a%vals
    end function mul_I3D2O_3D2Osym
    ...
    pure module function mul_3D2Osym_I3D2O(a, I2) result(res)
        ...
        type(ten_3D2Osym) :: res
        res%vals = a%vals
    end function mul_3D2Osym_I3D2O
end module mod_operator_I3D2O_3D2Osym