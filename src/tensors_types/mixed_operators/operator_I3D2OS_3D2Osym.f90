module mod_operator_I3D2OS_3D2Osym
    ...
    public :: operator(+)
    interface operator (+)
        module procedure sum_3D2Osym_I3D2OS
        module procedure sum_I3D2OS_3D2Osym
    end interface

    public :: operator(-)
    interface operator (-)
        module procedure sub_3D2Osym_I3D2OS
        module procedure sub_I3D2OS_3D2Osym
    end interface
    
    public :: operator(.ddot.)
    interface operator (.ddot.)
        module procedure ddot_I3D2OS_3D2Osym
        module procedure ddot_3D2Osym_I3D2OS
    end interface
    ...
    end function ddot_I3D2OS_3D2Osym
    ...
    pure module function ddot_3D2Osym_I3D2OS(b, I2) result(res)
        ...
        real(real64) :: res
        res = I2%val*(b%vals(1) + b%vals(2) + b%vals(3))
    end function ddot_3D2Osym_I3D2OS
    ...
    end function sum_I3D2OS_3D2Osym
    ...
    pure module function sum_3D2Osym_I3D2OS(a, I2) result(res)
        ...
        res%vals = a%vals
        res%vals(1:3) = res%vals(1:3) + I2%val
    end function sum_3D2Osym_I3D2OS
    ...
    end function sub_I3D2OS_3D2Osym
    ...
    pure module function sub_3D2Osym_I3D2OS(a, I2) result(res)
        ...
        res%vals = a%vals
        res%vals(1:3) = res%vals(1:3) - I2%val
    end function sub_3D2Osym_I3D2OS
end module mod_operator_I3D2OS_3D2Osym