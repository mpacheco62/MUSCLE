module mod_operator_I2OS_3D2Osym
    ...
    pure module function ddot_I2OS_3D2Osym(I2, b) result(res)
        implicit none
    ...
    pure module function ddot_3D2Osym_I2OS(b, I2) result(res)
        implicit none
        class(iden_2OS), intent(in) :: I2
        class(ten_3D2Osym), intent(in) :: b
        real(real64) :: res
    ...
    pure module function sum_I2OS_3D2Osym(I2, a) result(res)
        implicit none
        class(iden_2OS), intent(in) :: I2
    ...
    pure module function sum_3D2Osym_I2OS(a, I2) result(res)
        implicit none
        class(iden_2OS), intent(in) :: I2
        type(ten_3D2Osym), intent(in) :: a
        type(ten_3D2Osym) :: res
    ...
    pure module function sub_I2OS_3D2Osym(I2, a) result(res)
        implicit none
        class(iden_2OS), intent(in) :: I2
        type(ten_3D2Osym), intent(in) :: a
        type(ten_3D2Osym) :: res
    ...
    pure module function sub_3D2Osym_I2OS(a, I2) result(res)
        implicit none
        class(iden_2OS), intent(in) :: I2
        type(ten_3D2Osym), intent(in) :: a
        type(ten_3D2Osym) :: res
