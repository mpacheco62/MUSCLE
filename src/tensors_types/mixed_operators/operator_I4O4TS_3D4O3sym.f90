module mod_operator_I4O4TS_3D4O3sym
    ...
    ! pure function ddot_I4O4TS_3D4O3sym(I2, b) result(res)
    !     implicit none
    ...
    ! pure function ddot_3D4O3sym_I4O4TS(b, I2) result(res)
    !     implicit none
    !     class(iden_4O4TS), intent(in) :: I2
    !     class(ten_3D4O3sym), intent(in) :: b
    !     real(real64) :: res
    ...
    pure function sum_I4O4TS_3D4O3sym(I2, a) result(res)
        implicit none
        class(iden_4O4TS), intent(in) :: I2
    ...
    pure function sum_3D4O3sym_I4O4TS(a, I2) result(res)
        implicit none
        class(iden_4O4TS), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
    ...
    pure function sub_I4O4TS_3D4O3sym(I2, a) result(res)
        implicit none
        class(iden_4O4TS), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
    ...
    pure function sub_3D4O3sym_I4O4TS(a, I2) result(res)
        implicit none
        class(iden_4O4TS), intent(in) :: I2
        type(ten_3D4O3sym), intent(in) :: a
        type(ten_3D4O3sym) :: res
