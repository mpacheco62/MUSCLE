module mod_iden_4O3TS
    ...
    pure module function mul_I4O3TS_real64(IMod, a) result(res)
        implicit none
    ...
    pure module function mul_real64_I4O3TS(a, IMod) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: IMod
        real(real64), intent(in) :: a
        type(iden_4O3TS) :: res
    ...
    pure module function div_I4O3TS_real64(IMod, a) result(res)
        implicit none
        class(iden_4O3TS), intent(in) :: IMod
        real(real64), intent(in) :: a
        type(iden_4O3TS) :: res
