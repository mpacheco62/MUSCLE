module mod_iden_3D2O
    ...
    interface operator (+)
        ...
        module procedure sum_I3D2O_I3D2OMod
        module procedure sum_I3D2OMod_I3D2O
    end interface
    ...
    interface operator (-)
        ...
        module procedure sub_I3D2O_I3D2OMod
        module procedure sub_I3D2OMod_I3D2O
    end interface
...
contains
    ...
    pure module function sum_I3D2O_I3D2OMod(I2a, I2b) result(res)
        implicit none
        class(iden_3D2O), intent(in) :: I2a
        class(iden_3D2Omod), intent(in) :: I2b
        type(iden_3D2Omod) :: res
        res%val = 1D0 + I2b%val
    end function sum_I3D2O_I3D2OMod

    pure module function sum_I3D2OMod_I3D2O(I2a, I2b) result(res)
        implicit none
        class(iden_3D2Omod), intent(in) :: I2a
        class(iden_3D2O), intent(in) :: I2b
        type(iden_3D2Omod) :: res
        res%val = I2a%val + 1D0
    end function sum_I3D2OMod_I3D2O
    ...
    pure module function sub_I3D2O_I3D2OMod(I2a, I2b) result(res)
        implicit none
        class(iden_3D2O), intent(in) :: I2a
        class(iden_3D2Omod), intent(in) :: I2b
        type(iden_3D2Omod) :: res
        res%val = 1D0 - I2b%val
    end function sub_I3D2O_I3D2OMod

    pure module function sub_I3D2OMod_I3D2O(I2a, I2b) result(res)
        implicit none
        class(iden_3D2Omod), intent(in) :: I2a
        class(iden_3D2O), intent(in) :: I2b
        type(iden_3D2Omod) :: res
        res%val = I2a%val - 1D0
    end function sub_I3D2OMod_I3D2O
