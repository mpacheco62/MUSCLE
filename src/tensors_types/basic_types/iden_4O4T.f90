...
contains
    ...
    pure module function mul_I4O4T_real64(I2, a) result(res)
        implicit none
    ...
    pure module function mul_real64_I4O4T(a, I2) result(res)
        implicit none
        class(iden_4O4T), intent(in) :: I2
        real(real64), intent(in) :: a
        type(iden_4O4TS) :: res
    ...
    pure module function div_I4O4T_real64(I2, a) result(res)
        implicit none
        class(iden_4O4T), intent(in) :: I2
        real(real64), intent(in) :: a
        type(iden_4O4TS) :: res
