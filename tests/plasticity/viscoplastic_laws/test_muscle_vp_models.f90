module test_muscle_vp_models_mod
...
end module test_muscle_vp_models_mod


program test_muscle_vp_models
    use test_muscle_vp_models_mod
    implicit none
    logical :: passed
    ...
    stop 0
end program test_muscle_vp_models
